...
\begin{document}
	...
	\begin{table}[H]
		...
		\begin{tabular}{|l|l|l|}
			...
			\hline
			Prisma & 15.2+ & ORM de Vase de Datos \\
			\hline
		\end{tabular}
	\end{table}
	...
	Cuando un aprendiz forma parte de un grupo, el sistema automaticamente lo convierte en artista, a esto se le llama debut del artista
	...
	\begin{enumerate}
		...
		\item Seleccionar la fecha en la que se quiere la actividad .
	...
	Cada actividad tiene un ingreso asociado,que se puede visualizar desde el menu ingreso,donde se obtiene el acceso a todos los datos de los ingresos
	...
	El sistema permite consultar el listado de actividades registradas en la seccion Actividad, así como los ingresos asociados a cada una de ellas en la sección Ingresos. Permitiendo al ususario:
	...
	\subsection{Registro de un Álbumes}
	...
	\begin{enumerate}
		...
		\item Seleccionar botón Agregar en el área de trabajo.
		\item Ingresar datos correspondietnes en el formulario
	...
	\caption{Visualizacion de una Lista de Popularidad}
	\end{figure}
	...
	Este registro de contratos,ya sea con un artista o con un grupo,se realizan mediante la gestion de Talento y solicitud
	...
	\begin{itemize}
		\item Visualizar el listado de solicitudes en las que esta involucrado.
