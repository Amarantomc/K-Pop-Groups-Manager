...
de agencias y grupos de K-pop, cuyo objetivo es facilitar la administración de información relacionada con agencias de entretenimiento, grupos musicales, artistas, aprendices,actividades, contratos y producción musical.

\vspace{0.3cm}

El documento está dirigido a usuarios finales del sistema, tales como administradores,
directores de agencia, managers, artistas y aprendices, y proporciona una guía práctica
para el uso correcto de las funcionalidades disponibles según el rol asignado.
