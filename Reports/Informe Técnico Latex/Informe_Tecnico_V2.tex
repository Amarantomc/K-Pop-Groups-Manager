...
\begin{table}[H]
\centering
\caption{Diccionario - Tabla ArtistaSolicitaGrupo}
\begin{tabular}{|l|l|l|l|l|}
\hline
\textbf{Campo} & \textbf{Tipo de Dato} & \textbf{Restricción} & \textbf{Descripción} \\
\hline
...
\begin{itemize}
    ...
    \item Definición de rutas: clases que crean Routers y asignan endpoints, agrupadas y montadas en el router raíz (routes/index.ts) con prefijos claros (/group, /auth, /user).
